  ...
  return (
    ...
    <div className="footer-content d-flex justify-content-between">
        <div style={{width:'400px'}} className="title ">
            <h5 className='d-flex'><i class="fa-solid fa-cloud-arrow-up fa-beat me-2" style={{height:'45px'}}></i>
            Media Player</h5>
        ...
        <div className="links d-flex flex-column">
            ...
            <Link to={'/home'} style={{color:'white'}} className='text-decoration-none' href="" >Home</Link>
            <Link to={'/history'} style={{color:'white'}} className='text-decoration-none' href="" >Watch History</Link>
        </div>
