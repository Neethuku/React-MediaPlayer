...
function VideoCard({video,setDeleteVideoResponse,insideCategory}) {
  ...
  const handleShow = async () =>{
    ...
    const dragStarted = (e,id)=>{
      console.log("Drag strted...video id:"+id);
  ...
  return (
    ...
    <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe className='w-100' height="387" src={`${video?.link}?autoplay=1`}title={video?.caption} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; 
